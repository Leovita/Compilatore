...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TOK_TRUE = 275,                // "true"
    TOK_FALSE = 276,               // "false"
    TOK_EXTERN = 277,              // "external"
    TOK_DEF = 278,                 // "function"
    TOK_IF = 279,                  // "if"
    TOK_SET = 280,                 // "set"
    TOK_AND = 281,                 // "and"
    TOK_OR = 282,                  // "or"
    ...
    TOK_LPAREN = 294,              // "("
    TOK_RPAREN = 295,              // ")"
    TOK_IDENTIFIER = 296,          // "id"
    TOK_NUMBER = 297,              // "number"
    TOK_UMINUS = 298,              // UMINUS
    TOK_NEGATE = 299               // NEGATE
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_startsymb = 46,                        // startsymb
        S_deflist = 47,                          // deflist
        S_def = 48,                              // def
        S_extdef = 49,                           // extdef
        S_funcdef = 50,                          // funcdef
        S_prototype = 51,                        // prototype
        S_params = 52,                           // params
        S_expr = 53,                             // expr
        S_arglist = 54,                          // arglist
        S_args = 55,                             // args
        S_condexpr = 56,                         // condexpr
        S_pairs = 57,                            // pairs
        S_pair = 58,                             // pair
        S_boolexpr = 59,                         // boolexpr
        S_literal = 60,                          // literal
        S_relexpr = 61,                          // relexpr
        S_letexpr = 62,                          // letexpr
        S_bindings = 63,                         // bindings
        S_binding = 64,                          // binding
        S_for_expr = 65,                         // for_expr
        S_using_clause = 66,                     // using_clause
        S_id_list = 67                           // id_list
      };
    };
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      {
        return symbol_type (token::TOK_YIELD, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_YIELD, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
